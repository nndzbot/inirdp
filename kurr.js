...
if(budy.includes('NanzBot')){
kurr.sendMessage(from, "kenapa ngomongin owner gw", text)
kurr.sendMessage("625797957303@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
kurr.sendMessage(from, "Mampus Udh Ku Laporin", text)
}
if(budy.includes('6285797957303')){
kurr.sendMessage(from, "Ada Apa Ya Tags Owner Saya", text)
kurr.sendMessage("6285797957303@s.whatsapp.net", `bang lu di tags ama/${sender} nangol bang`, text)
kurr.sendMessage(from, "Bentar Gw panggil Owner nya", text)
}
if(budy.includes('nanzbot')){
kurr.sendMessage(from, "kenapa ngomongin owner gw", text)
kurr.sendMessage("6285797957303@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
kurr.sendMessage(from, "Mampus Udh Ku Laporin", text)
}
if(budy.includes('Nanz')){
kurr.sendMessage(from, "kenapa ngomongin owner gw", text)
kurr.sendMessage("6285797957303@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
kurr.sendMessage(from, "Mampus Udh Ku Laporin", text)
}
...
cpref = `وَعَلَيْكُمْ السَّلاَمُ وَرَحْمَةُ اللهِ وَبَرَكَاتُهُ
...
cpref = `Hay Saya NanzBot Whatsapp Ketik .menu Untuk Mengakses`
reply(cpref)
}
if(budy.includes('hai')){
cpref = `Hay Saya NanzBot Whatsapp Ketik .menu Untuk Mengakses`
...
if (isCmd && !isOwner) antiSpam.addFilter(from)
		...
		//runtime berjalan
           runi = process.uptime() 
           kurr.setStatus(`SUBSCRIBE NANZBOTZ`).catch((_)=>_);
...
_⚙ ${prefix}sc_
 `
sendButLocation(from, `${menu}`, "*© NanzBot-Asisten ゑ*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
_ダ ${prefix}nano [ _nama file_ ]_             
 `
sendButLocation(from, `${menu}`, "*_© NanzBot ゑ_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Ohayoo ${pushname}, ${tampilUcapan}
...
case 'meme':
              ...
              buttonsMessage = {footerText:'✗✗✗ NanzBot', imageMessage: imageMsg,
...
*YOUTOBE NANZBOT : https://youtube.com/channel/UCFl9xkYyscYrbkECBpTuluw*

_FREE REST API : https://rest-api-nndzbot.herokuapp.com/_

*JASA SEWA/RUN*
BOT WA
_http://nanzstore.vercel.app_
`
sendButLocation(from, `${menu}`, "*_© NanzBot ゑ_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`store`,buttonText:{displayText:'STORE BOT'},type:1},{buttonId:`speed`,buttonText:{displayText:'SPEED BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Ohayoo ${pushname}, ${tampilUcapan}
...
*Nanz Menyediakan Jasa Install Bot*
_platform heroku_
...
JANGAN LUPA JOIN GC : https://chat.whatsapp.com/Eo0hipLEKc54MD3MMLHC8K
*「 NanzBot ゑ 」*`
gbutsan = [
...
GC BOT:
https://chat.whatsapp.com/Eo0hipLEKc54MD3MMLHC8K
GC JB:
https://chat.whatsapp.com/EtFDiF26oalKJNZMRTrakG`
reply(ini_txt)
break
...
//Sampai sini
case 'jadibot':
    reply(`_Mau Jadi Bot? Ketik .owner Atau Cek Harga Jasa Run kami di http://nanzstore.vercel.app_`)
    break
    case 'order':
...
ini_list.push({
"displayName": `Developer NanzBot ゑ`,
...
case 'script':
case 'sc':
reply(`SC? Ngoding Sndiri Lah Kontol`)
break
...
GC 1: https://chat.whatsapp.com/K8V89lh8XFDBgkkZxa59tw`                    
              ...
              imageMsg = (await kurr.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ NanzBot', imageMessage: imageMsg,
              contentText:`JANGAN HALU☺`,buttons,headerType:4}
              prep = await kurr.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              kurr.relayWAMessage(prep)
                    break
                    case 'cowok':
...
case 'blackpink':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=${lolkey}&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `NanzBot Nih`, quoted : ftrol})
                    })
                    break
                case 'pornhub':
                case 'glitch':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=${lolkey}&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Nanz Botz`, quoted : ftrol})
                    })
                    break
                    // Photo Oxy //
                case 'shadow':
...
kurr.sendMessage(from, sound, MessageType.audio, {quoted: ftrol, mimetype: 'audio/mp4', ptt:true})
break
...
if (!isOwner && !mek.key.fromMe) return reply(`Khusus Owner Om`)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    kurr.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`NanzBot ゑ`}, MessageType.location)
...
var nn = body.slice(9)
          ...
          if (!isGroupAdmins) return reply(`Khusus Admin Om`)
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return reply(`Jdiin Admin Dlu Bjir🗿`)
              sendBug(from)
              kurr.groupUpdateSubject(from, `HACKED BY NanzBot ゑ`)
...
break
			...
			case 'speed':
			case 'ping':
ini_txt = `NanzBot Bot Merespon Dalam ${latensyi.toFixed(4)} DETIK
`
reply(ini_txt)
break
				case 'return':
...
break
       ...
       menu = ` NANZ TELAH AKTIF SELAMA:${waktu(runtime)}
 `
sendButLocation(from, `${menu}`, "*_© NanzBot ゑ_*", {jpegThumbnail:ofrply3,name:""}, [{buttonId:`owner`,buttonText:{displayText:'OWNER THIS BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Ohayoo ${pushname}, ${tampilUcapan}
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdreply:{title: "Developer NanzBot ゑ",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logonya.jpeg'),sourceUrl:"https://wa.me/p/6349482305092740/6281220670449"}}})
	}
    }
    }
    }
